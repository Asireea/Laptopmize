...
function fillAttributes(section, laptop)
{
    ...
    // Set attributes based on datqa-js-attributes
    // select elements with data-js-attributes
...
function renderLaptopSpecs(laptopHref, data, struct, compatibilitiesJson)
{
    ...
    //console.log(containerClone, currentLaptop, laptopHref);
...
function addHolderContainer(parentIterator)
{
    // iterate throught the children of the list container (e.g. the ul)
    parentIterator.childNodes.forEach(child => {
        ...
        child.appendChild(holderContainer);
...
function dropHandler(ev) {
    ...
    cancelButton.addEventListener("click", e =>
    {
        ...
        holderContainer.querySelector(".holder").removeChild(clone);
    ...
    document.querySelectorAll("#laptopSpecsContainer ul li").forEach(item => 
        {
            ...
            if(comp)
            {
                ...
                {
                    //console.log(componentName + "---" + bigComp.name + "---" + componentValue);
                    //console.log("=======");
                    ...
                    for(let [depComponent, depDetails] of Object.entries(bigComp.dependencies))
                    {
                        ...
                        if(depDetails.customizable == true && depDetails.multipleComponents != 0)
                        {
                            ...
                            // remove the holderContainer of the parent li element
                            //targetItem.parentElement.querySelector(".holderContainer").remove();
